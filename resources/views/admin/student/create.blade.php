<x-admin_layout>
    ...
    <section class="bg-yellow dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900">Add a new student</h2>
            <form action="/admin/students/store" method="post">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    {{-- <div>
                        <label for="department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grade/class</label>
